...
NEW = [
 ...
 ('rhythm','holographic','FPx','Rhythm','Finding a groove',
  ...
  '+{perCompletionMult} FPx per completion, +{bonusMult} more once past {threshold}'),
 ('clockwork','prismatic','FP','Clockwork','Never misses a beat',
  ...
  '+{perCompletionFP} FP per completion, plus a streak growing {growthPerTick} per week this player clears {threshold}'),
 ...
 ('stratosphere','prismatic','FPx','Stratosphere','Thin air up here',
  ...
  '+{perHundredMult} FPx per 100 passing yards, plus a streak growing {growthPerTick} per week past {threshold}'),
 ...
 ('marksman','holographic','FPx','Marksman','Nothing wasted',
  ...
  '+{perGoodThrowMult} FPx per well-placed throw, +{cleanSheetMult} more on 0 bad throws'),
 ('dead_eye','prismatic','FP','Dead Eye','Never off target',
  ...
  '+{perGoodThrowFP} FP per well-placed throw, plus a streak growing {growthPerTick} per clean sheet'),
 # RB — carries, labour
 ('beast_of_burden','holographic','FPx','Beast of Burden','Carrying the load',
  'FPx on every carry, and more once the workload passes 25.',
  '+{perCarryMult} FPx per carry, +{bonusMult} more once past {threshold}'),
 ('iron_man','prismatic','FP','Iron Man','Never comes off the field',
  ...
  '+{perCarryFP} FP per carry, plus a streak growing {growthPerTick} per week past {threshold}'),
 ...
 ('odyssey','prismatic','FP','Odyssey','The long road',
  ...
  '+{perYardFP} FP per rushing yard, plus a streak growing {growthPerTick} per week past {threshold}'),
 # RB — rush TDs, force
 ...
 ('grinder','holographic','FPx','Grinder','Earning every inch',
  ...
  '+{perYardMult} FPx per yard after contact, +{ratioMult} more when they exceed half the total'),
 ('landslide','prismatic','FP','Landslide','Gathering weight',
  ...
  '+{perYardFP} FP per yard after contact, plus a streak growing {growthPerTick} per week past {threshold}'),
 ...
 ('custody','holographic','FPx','Custody','Safe hands',
  ...
  '+{perReceptionMult} FPx per reception, +{bonusMult} more once past {threshold}'),
 ('tenure','prismatic','FP','Tenure','Long service',
  'FP on every catch, plus a streak for every week the count passes eight.',
  '+{perReceptionFP} FP per reception, plus a streak growing {growthPerTick} per week past {threshold}'),
 ...
 ('territory','holographic','FPx','Territory','Claiming ground',
  ...
  '+{perYardMult} FPx per receiving yard, +{gate1}/{gate2}/{gate3} more at 75, 125 and 175'),
 ('dominion','prismatic','FP','Dominion','The whole field',
  'FP on every receiving yard, plus a streak for every hundred-yard week.',
  '+{perYardFP} FP per receiving yard, plus a streak growing {growthPerTick} per week past {threshold}'),
 ...
 ('getaway','prismatic','FP','Getaway','Gone',
  ...
  '+{perYardFP} FP per YAC yard, plus a streak growing {growthPerTick} per week past {threshold}'),
 # K — punting, burial
 ...
 ('undertaker','prismatic','FP','Undertaker','Bury them',
  ...
  '+{perPuntFP} FP per punt inside the 20, plus a streak growing {growthPerTick} per week past {threshold}'),
