...
EFFECT_DETAIL_TEMPLATES = {
    ...
    "bonsai": "+{baseFP} FP guaranteed. The more {triggerLabel} your roster posts this week, the higher the chance the base permanently grows by +{growthFP} FP. 90% chance at the current threshold. Each grow raises the threshold for next week.",
    # ── New cards (FP/FPx rebalance) ──
