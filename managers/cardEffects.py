...
EFFECT_DETAIL_TEMPLATES = {
    ...
    "bonsai": "+{baseFP} FP guaranteed. Roster {triggerLabel} scale a weekly growth roll from 2% to 100%, hitting 90% at the threshold. Each grow adds +{growthFP} FP permanently and raises the next threshold.",
    # ── New cards (FP/FPx rebalance) ──
