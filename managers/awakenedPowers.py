...
_POWERS = {
    ...
    'no_clip': {'name': 'No-Clip', 'concept': 'phases through solid matter like a glitch in the world',
        'throw': ['{player} fires it clean through three defenders to {receiver} for {yards} yards',
                  'the pass clips through the rush untouched and {player} hits {receiver} for {yards} yards'],
        ...
        'catch': ['{passer} lets it fly and {player} lets the ball pass through the defender into their hands for {yards} yards',
    ...
    'railgun': {'name': 'Railgun', 'concept': 'fires the ball like an electromagnetic slug',
        'throw': ['{player} glows white and rifles the spiral to {receiver} on a flat line for {yards} yards',
                  'a crack of electricity and {player} sends it to {receiver} for {yards} yards'],
    ...
    'warp': {'name': 'Warp', 'concept': 'moves at a speed the field cannot track',
        ...
        'catch': ['{passer} throws it up and {player} warps to the catch point to wait for it to arrive, good for {yards} yards'],
    ...
    'magnet': {'name': 'Magnet', 'concept': 'turns magnetic to the ball',
        'catch': ['{passer} lets it fly and {player} magnetizes the ball out of the air for {yards} yards',
                  '{passer} throws it up, it ricochets off two defenders, and snaps to {player} anyway for {yards} yards'],
    ...
    'flypaper': {'name': 'Flypaper', 'concept': 'their hands are flypaper; nothing comes loose',
        'catch': ['{passer} throws it up and the ball sticks to {player} the instant it arrives, good for {yards} yards',
                  '{passer} lets it fly, a defender swats it, and it just re-sticks to {player}, gone for {yards} yards'],
    ...
    'slingshot': {'name': 'Slingshot', 'concept': 'fires the ball off a giant slingshot',
        'throw': ['{player} loads the ball into a slingshot and snaps it to {receiver} across the field for {yards} yards',
                  '{player} rockets the ball off an invisible band into {receiver} for {yards} yards'],
    ...
    'telepathy': {'name': 'Telepathy', 'concept': 'thrower and catcher share one mind',
        ...
        'catch': ['{passer} reads {player} and {player} reads the throw before it leaves the hand to be waiting for {yards} yards']},
    'smoke_bomb': {'name': 'Smoke Bomb', 'concept': 'vanishes in a puff of smoke',
        'throw': ['{player} vanishes in a puff of smoke and the ball comes out of the cloud to {receiver} for {yards} yards',
                  'the rush hits smoke and {player} is already gone, hitting {receiver} for {yards} yards'],
    ...
    'good_boy': {'name': 'Good Boy', 'concept': 'the ball becomes a loyal dog',
        'catch': ['{passer} lets it fly, {player} turns the ball into a loyal dog, and it bounds into their arms for {yards} yards',
                  '{passer} throws it up, the ball trots over, and curls up in the hands of {player} for {yards} yards'],
    ...
    'invisible_ink': {'name': 'Invisible Ink', 'concept': 'the ball turns invisible',
        'catch': ['{passer} throws it up, {player} turns the ball invisible, and the corner has no idea they have it for {yards} yards',
                  '{passer} lets it fly, the defense loses the ball, and only {player} knows where it lands for {yards} yards'],
    ...
    'magnet_hands': {'name': 'Magnet Hands', 'concept': 'magnetized hands rip it free',
        'catch': ['{passer} lets it fly and the ball snaps to the magnetized hands of {player} for {yards} yards'],
