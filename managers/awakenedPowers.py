...
_POWERS = {
    ...
    'no_clip': {'name': 'No-Clip', 'concept': 'phases through solid matter like a glitch in the world',
        'throw': ['{player} alters the balls programming so it phases through defenders and hits {receiver} for {yards} yards',
                  '{player} clips the pass clean through the rush untouched and hits {receiver} for {yards} yards'],
        'run':   ['{player} phases clean through the tackle and is gone for {yards} yards',
                  '{player} flips off their collision and the hands pass right through them as they glide {yards} yards downfield'],
        'catch': ['{passer} lets it fly and {player} phases the ball through the defender into their hands for {yards} yards',
                  '{passer} throws it up and {player} reaches a hand through the corner to pull it in for {yards} yards'],
        'kick':  ['{player} phases it clean through the line and the uprights'],
        'pick':  ['{player} phases a hand through the receiver and snatches the ball off it',
                  '{player} clips the throw right through themselves and is suddenly holding it'],
    ...
    'pixelate': {'name': 'Pixelate', 'concept': 'disassembles into pixels and reassembles downfield',
        'throw': ['{player} scatters the throw into pixels, streams it past the rush, and reforms it in stride for {receiver} for {yards} yards'],
        'run':   ['{player} bursts into pixels and reassembles downfield for {yards} yards',
                  '{player} scatters to static so the tackle closes on nothing, then reforms past it for {yards} yards'],
    ...
    'take_flight': {'name': 'Take Flight', 'concept': 'simply takes off and flies',
        ...
        'catch': ['{passer} lofts it and {player} launches into the air, hangs there, and plucks it from the sky for {yards} yards'],
    ...
    'railgun': {'name': 'Railgun', 'concept': 'fires the ball like an electromagnetic slug',
        'throw': ['{player} glows white and rifles the spiral to {receiver} on a flat line for {yards} yards',
                  '{player} cracks off an electric bolt of a throw to {receiver} for {yards} yards'],
    ...
    'wormhole': {'name': 'Wormhole', 'concept': 'folds the field so the ball threads anything',
        'throw': ['{player} folds the coverage shut and threads it to {receiver} through a tunnel for {yards} yards',
                  '{player} folds the throwing window around the ball and drops it in to {receiver} for {yards} yards'],
        'catch': ['{passer} lets it fly and {player} opens a pocket of space the ball drops into for {yards} yards'],
    ...
    'blink': {'name': 'Blink', 'concept': 'teleports a short hop',
        'throw': ['{player} blinks clear of the rush and lets it fly to {receiver} for {yards} yards'],
    ...
    'warp': {'name': 'Warp', 'concept': 'moves at a speed the field cannot track',
        ...
        'catch': ['{passer} throws it up and {player} warps to the catch point and waits for it to arrive, good for {yards} yards'],
    ...
    'juggernaut': {'name': 'Juggernaut', 'concept': 'turns to unstoppable iron',
        'run':   ['{player} turns to solid iron and bowls the whole pile over for {yards} yards',
                  '{player} turns to iron and grinds forward as the tacklers ragdoll off for {yards} yards'],
        'pick':  ['{player} bulldozes into the pocket and snatches the rushed throw in their iron grip'],
        'strip': ['{player} sets as a wall of iron, the runner crashes in, and the ball pops free']},
    ...
    'ice_rink': {'name': 'Ice Rink', 'concept': 'freezes the field to a sheet of ice',
        ...
        'strip': ['{player} flashes the turf to ice, the runner wipes out, and {player} skates off with the ball']},
    ...
    'freestyle': {'name': 'Freestyle', 'concept': 'literally swims down the field',
        ...
        'catch': ['{passer} lets it fly and {player} swims up through the coverage and surfaces with the ball for {yards} yards'],
    ...
    'magnet': {'name': 'Magnet', 'concept': 'turns magnetic to the ball',
        'catch': ['{passer} lets it fly and {player} magnetizes the ball out of the air for {yards} yards',
                  '{passer} throws it up, it ricochets off two defenders, and {player} magnetizes it in anyway for {yards} yards'],
        'pick':  ['{player} bends the throw off its line and into their hands',
                  '{player} holds up a palm and drags the pass in'],
    ...
    'flypaper': {'name': 'Flypaper', 'concept': 'their hands are flypaper; nothing comes loose',
        'catch': ['{passer} throws it up and {player} flypapers it to their gloves the instant it arrives, good for {yards} yards',
                  '{passer} lets it fly, a defender swats it, and {player} re-sticks it to their hand anyway, gone for {yards} yards'],
        'pick':  ['{player} flypapers the pass to their hand as it glances off the receiver'],
        'strip': ['{player} slaps the ball and flypapers it off the runner into their grip']},

    'rubberband': {'name': 'Rubberband', 'concept': 'arms stretch like taffy',
        'catch': ['{passer} throws it up and {player} stretches an arm ten feet across the seam to reel it in for {yards} yards',
    ...
    'octopus': {'name': 'Octopus', 'concept': 'sprouts a tangle of extra arms',
        'catch': ['{passer} lets it fly, {player} unfurls eight arms, and there is no dropping it now, good for {yards} yards',
    ...
    'colossus': {'name': 'Colossus', 'concept': 'grows to fill the field',
        'catch': ['{passer} throws it up and {player} expands to fill the end zone and boxes everyone out for it, good for {yards} yards'],
    ...
    'tractor_beam': {'name': 'Tractor Beam', 'concept': 'the target pulls the ball in',
        ...
        'catch': ['{passer} lets it fly and {player} locks a beam on it to drag the ball into their hands for {yards} yards'],
    ...
    'trebuchet': {'name': 'Trebuchet', 'concept': 'launches it like a siege engine',
        ...
        'throw': ['{player} cranks back and catapults the ball to {receiver} the length of the field for {yards} yards']},
    ...
    'black_hole': {'name': 'Black Hole', 'concept': 'opens a collapsing gravity well',
        ...
        'catch':   ['{passer} lets it fly and {player} opens a well at their chest the ball cannot escape, good for {yards} yards'],
    ...
    'rewind': {'name': 'Rewind', 'concept': 'rewinds a couple seconds to be where they need to be',
        'catch':   ['{passer} lets it fly, {player} drops it, rewinds two seconds, and brings it in clean for {yards} yards'],
    ...
    'comet': {'name': 'Comet', 'concept': 'the ball ignites into a comet',
        'throw': ['{player} ignites the ball and streaks it to {receiver} trailing fire for {yards} yards',
                  '{player} sends a comet tail chasing the spiral to {receiver} in stride, good for {yards} yards'],
    ...
    'slingshot': {'name': 'Slingshot', 'concept': 'fires the ball off a giant slingshot',
        'throw': ['{player} loads the ball into a slingshot and snaps it to {receiver} across the field for {yards} yards',
                  '{player} fires the ball off an invisible band into {receiver} for {yards} yards'],
    ...
    'heat_seeker': {'name': 'Heat-Seeker', 'concept': 'the ball locks on and homes in',
        'throw': ['{player} locks the ball onto {receiver} and it corrects mid-flight for {yards} yards',
                  '{player} banks it around a defender to {receiver} like it has a guidance chip, good for {yards} yards'],
        'catch': ['{passer} lets it fly, {player} homes the ball in, and it thumps into their chest for {yards} yards'],
    ...
    'auto_aim': {'name': 'Auto-Aim', 'concept': 'a crosshair snaps to the target',
        'throw': ['{player} snaps a crosshair to {receiver} and the ball follows it in for {yards} yards',
                  '{player} locks onto {receiver} and the throw cannot miss, good for {yards} yards'],
    ...
    'telepathy': {'name': 'Telepathy', 'concept': 'thrower and catcher share one mind',
        'throw': ['{player} thinks the route and {receiver} is already there for {yards} yards',
                  '{player} needs no signal and puts it to {receiver} exactly where both of them know, good for {yards} yards'],
        'catch': ['{passer} lets it fly and {player} reads the throw before it leaves the hand and is already waiting for {yards} yards']},
    'smoke_bomb': {'name': 'Smoke Bomb', 'concept': 'vanishes in a puff of smoke',
        'throw': ['{player} vanishes in a puff of smoke and slings it out of the cloud to {receiver} for {yards} yards',
    ...
    'trapdoor': {'name': 'Trapdoor', 'concept': 'drops through a trapdoor and pops up elsewhere',
        'throw': ['{player} drops through a trapdoor and the throw comes from somewhere new to {receiver} for {yards} yards',
                  '{player} leaves the pocket collapsing on an empty patch of grass and hits {receiver} for {yards} yards'],
    ...
    'bullet_time': {'name': 'Bullet Time', 'concept': 'time crawls to a stop around them',
        'throw': ['{player} crawls the world to a stop, picks the seam at their leisure, and finds {receiver} for {yards} yards'],
    ...
    'decoy': {'name': 'Decoy', 'concept': 'leaves a decoy for the defense to hit',
        'throw': ['{player} lets the rush tackle a cardboard cutout and throws free to {receiver} for {yards} yards'],
    ...
    'grease': {'name': 'Grease', 'concept': 'too slippery to hold onto',
        'throw': ['{player} greases free as the sack slides right off and fires to {receiver} for {yards} yards'],
    ...
    'jelly': {'name': 'Jelly', 'concept': 'turns to jelly and oozes free',
        'throw': ['{player} turns to jelly, oozes out of the sack, and slings it to {receiver} for {yards} yards'],
        'run':   ['{player} turns to jelly and the arms pass through their body as they wobble onward for {yards} yards'],
    ...
    'hyperdrive': {'name': 'Hyperdrive', 'concept': 'jumps to lightspeed',
        ...
        'catch': ['{passer} throws it up and {player} jumps to the catch point before the ball arrives, good for {yards} yards'],
    ...
    'conveyor_belt': {'name': 'Conveyor Belt', 'concept': 'the turf carries them like a belt',
        'run':   ['{player} turns the turf to a conveyor and rides it past everyone for {yards} yards',
                  '{player} runs a belt under their feet and rides it clear of the pile for {yards} yards'],
    ...
    'boulder': {'name': 'Boulder', 'concept': 'turns to solid rock',
        'run':   ['{player} turns to solid rock and grinds the pile backward for {yards} yards',
                  '{player} turns to a half-ton of granite and the tacklers shatter against them, gone for {yards} yards'],
        'catch': ['{passer} throws it up, {player} sets like a boulder, and nobody is moving them off the ball, good for {yards} yards'],
        'pick':  ['{player} sets like a boulder in the lane and the pass caroms into their hands'],
        'strip': ['{player} sets like an immovable boulder, the runner hits them, and the ball jars loose']},
    'afterimage': {'name': 'Afterimage', 'concept': 'leaves afterimages the defense covers instead',
        'run':   ['{player} leaves an afterimage for the defender to tackle and is already gone for {yards} yards',
                  '{player} leaves a trail of ghosts and the tackle hits the wrong one, good for {yards} yards'],
        'catch': ['{passer} lets it fly and {player} leaves the corner covering an afterimage to make the catch clean for {yards} yards'],
    ...
    'matrix': {'name': 'Matrix', 'concept': 'bends impossibly to dodge',
        ...
        'throw': ['{player} bends backward out of the sack and throws upside down to {receiver} for {yards} yards'],
    ...
    'heartthrob': {'name': 'Heartthrob', 'concept': 'the defenders fall in love',
        ...
        'catch': ['{passer} throws it up and {player} leaves the corner too smitten to contest the catch, good for {yards} yards'],
    ...
    'shrink_ray': {'name': 'Shrink Ray', 'concept': 'shrinks to slip past',
        ...
        'catch': ['{passer} throws it up and {player} shrinks under the coverage to grab it at shoelace height for {yards} yards'],
    ...
    'skunk': {'name': 'Skunk', 'concept': 'stinks so bad everyone avoids them',
        'run':   ['{player} unleashes a stench that clears a lane as the defenders gag and give room for {yards} yards',
                  '{player} reeks so badly nobody wants within five yards of them, gone for {yards} yards'],
        'catch': ['{passer} lets it fly and {player} backs the corner off the smell to catch it uncovered for {yards} yards'],
    ...
    'liquify': {'name': 'Liquify', 'concept': 'turns to liquid and pours through',
        'run':   ['{player} turns to liquid and pours through the gap in the line for {yards} yards',
                  '{player} melts to a puddle and the tackle splashes through where they used to be, gone for {yards} yards'],
    ...
    'sandman': {'name': 'Sandman', 'concept': 'puts the defenders to sleep',
        'run':   ['{player} lulls the defenders to sleep and jogs past the yawning front for {yards} yards',
                  '{player} rolls a wave of drowsiness over the front and strolls through for {yards} yards'],
        'catch': ['{passer} throws it up and {player} lets the corner nod off to catch it in peace for {yards} yards'],
    ...
    'photobomb': {'name': 'Photobomb', 'concept': 'pops up suddenly behind the defense',
        ...
        'catch': ['{passer} lets it fly and {player} pops up uncovered behind the secondary for the grab, good for {yards} yards'],
    ...
    'steamroller': {'name': 'Steamroller', 'concept': 'flattens everyone like a roller',
        'run':   ['{player} flattens the first wave into the turf like a steamroller for {yards} yards',
                  '{player} rolls over the defenders and flattens them two-dimensional, gone for {yards} yards'],
    ...
    'tank': {'name': 'Tank', 'concept': 'rolls forward as an actual tank',
        'run':   ['{player} rolls forward as a tank and the line bounces off the treads for {yards} yards',
                  '{player} armors up to a tank hull, shrugs off the arm tackles, and grinds ahead for {yards} yards'],
    ...
    'third_arm': {'name': 'Third Arm', 'concept': 'sprouts a third arm',
        'catch': ['{passer} throws it up and {player} sprouts a third arm from the chest to snag the high ball for {yards} yards',
                  '{passer} lets it fly and {player} reaches an extra hand up where two could not, good for {yards} yards'],
    ...
    'vacuum': {'name': 'Vacuum', 'concept': 'inhales the ball in',
        'catch': ['{passer} lets it fly, {player} inhales, and the ball gets sucked straight into their grip for {yards} yards',
                  '{passer} throws it up, {player} opens a vacuum at the chest, and the ball cannot resist for {yards} yards'],
    ...
    'gravity_well': {'name': 'Gravity Well', 'concept': 'opens a well the ball falls into',
        'catch': ['{passer} throws it up and {player} opens a gravity well at their palms the ball drops into for {yards} yards',
                  '{passer} lets it fly and {player} curves the ball down out of its arc into their hands for {yards} yards'],
    ...
    'web_shooter': {'name': 'Web-Shooter', 'concept': 'shoots a web and reels it in',
        'catch': ['{passer} lets it fly and {player} fires a web at the ball to reel it into their hands for {yards} yards',
                  '{passer} throws it up and {player} snaps a strand out to yank the catch back for {yards} yards'],
    ...
    'do_over': {'name': 'Do-Over', 'concept': 'rewinds a drop and redoes it',
        'catch': ['{passer} lets it fly, {player} drops it, rewinds two seconds, and brings it in clean for {yards} yards',
                  '{passer} throws it up, {player} un-happens the bobble, and settles the ball into their hands for {yards} yards'],
    ...
    'good_boy': {'name': 'Good Boy', 'concept': 'the ball becomes a loyal dog',
        'catch': ['{passer} lets it fly, {player} turns the ball into a loyal dog, and it bounds into their arms for {yards} yards',
                  '{passer} throws it up, {player} whistles, and the ball trots over and curls up in their hands for {yards} yards'],
        'pick':  ['{player} whistles and the ball decides it likes them better and leaps into their arms'],
        'strip': ['{player} whistles the ball loyal, it wriggles loose from the runner, and trots over to them']},
    'invisible_ink': {'name': 'Invisible Ink', 'concept': 'the ball turns invisible',
        'catch': ['{passer} throws it up, {player} turns the ball invisible, and the corner has no idea they have it for {yards} yards',
                  '{passer} lets it fly, {player} fades the ball from sight, and only they know where it lands for {yards} yards'],
        'throw': ['{player} vanishes the ball in flight and it reappears in the hands of {receiver} for {yards} yards'],
    ...
    'telescope': {'name': 'Telescope', 'concept': 'arms telescope out',
        'catch': ['{passer} throws it up and {player} telescopes both arms out ten feet to pluck it from the sky for {yards} yards',
                  '{passer} lets it fly and {player} extends like a spyglass to snag the uncatchable for {yards} yards'],
    ...
    'gumby': {'name': 'Gumby', 'concept': 'bends and stretches like clay',
        'catch': ['{passer} throws it up and {player} stretches a rubber arm up to reel the high ball in for {yards} yards',
                  '{passer} lets it fly and {player} bends like clay to wrap around the ball for {yards} yards'],
    ...
    'fishing_rod': {'name': 'Fishing Rod', 'concept': 'casts an arm out like a line',
        'catch': ['{passer} lets it fly and {player} casts an arm out like a line to hook the ball in for {yards} yards',
                  '{passer} overthrows it and {player} reels it back like a prize catch for {yards} yards'],
    ...
    'butterfly_net': {'name': 'Butterfly Net', 'concept': 'pulls a giant net from nowhere',
        'catch': ['{passer} lets it fly and {player} pulls a giant net from their sleeve to scoop the ball in for {yards} yards',
                  '{passer} throws the deep ball and {player} swallows it out of the air with the net for {yards} yards'],
    ...
    'kaiju': {'name': 'Kaiju', 'concept': 'grows into a monster',
        'catch': ['{passer} throws it up and {player} grows into a kaiju to pluck it over the tiny defenders for {yards} yards',
                  '{passer} lets it fly and {player} closes a monster hand around the ball above the crowd for {yards} yards'],
    ...
    'redwood': {'name': 'Redwood', 'concept': 'grows into a towering tree',
        'catch': ['{passer} throws it up and {player} grows into a redwood to high-point it above everyone for {yards} yards',
                  '{passer} lets it fly, {player} digs roots in, and rises untouchable over the corner for {yards} yards'],
    ...
    'monolith': {'name': 'Monolith', 'concept': 'becomes an immovable slab',
        'catch': ['{passer} throws it up and {player} hardens into a monolith to box everyone off the ball for {yards} yards',
                  '{passer} lets it fly, {player} rises like a black slab, and the defenders bounce away from the catch for {yards} yards'],
    ...
    'hot_air': {'name': 'Hot Air', 'concept': 'inflates and floats over everyone',
        'catch': ['{passer} throws it up and {player} inflates like a balloon to float up over the secondary for {yards} yards',
                  '{passer} lets it fly, {player} puffs full of hot air, and rises above the crowd for it for {yards} yards'],
    ...
    'eclipse': {'name': 'Eclipse', 'concept': 'blots out the sun over the defender',
        'catch': ['{passer} lets it fly and {player} blots out the sun over the corner to catch it in the dark for {yards} yards',
                  '{passer} throws it up, {player} drops a shadow over the defender, and the ball is theirs for {yards} yards'],
    ...
    'autopilot': {'name': 'Autopilot', 'concept': 'the kick steers itself',
        ...
        'throw': ['{player} sets it to autopilot and the throw flies itself to {receiver} for {yards} yards'],
    ...
    'gps': {'name': 'GPS', 'concept': 'navigates the ball by coordinates',
        ...
        'throw': ['{player} locks the coordinates of {receiver} and the ball routes in for {yards} yards'],
    ...
    'magnet_posts': {'name': 'Magnet Posts', 'concept': 'the uprights magnetize the ball',
        'kick': ['{player} magnetizes the uprights and drags the kick dead through the middle',
                 '{player} charges the posts to pull the ball in no matter the angle']},
    'laser_guided': {'name': 'Laser-Guided', 'concept': 'paints the target with a laser',
        ...
        'throw': ['{player} laser-paints {receiver} and the throw rides the line in for {yards} yards'],
    ...
    'highway_robbery': {'name': 'Highway Robbery', 'concept': 'robs the ball in broad daylight',
        'catch': ['{passer} lets it fly, {player} snatches it like it was theirs all along, and strolls off for {yards} yards'],
    ...
    'ball_magnet': {'name': 'Ball Magnet', 'concept': 'the ball is drawn to them',
        'catch': ['{passer} lets it fly and {player} curves the ball off its line to stick it to their hands for {yards} yards'],
        'pick':  ['{player} bends the throw across the field and magnetizes it into their hands',
                  '{player} draws the ball in no matter where it was aimed'],
    ...
    'the_heist': {'name': 'The Heist', 'concept': 'a planned, clean robbery',
        'catch': ['{passer} lets it fly but {player} planned the whole thing and was always taking this one, good for {yards} yards'],
    ...
    'portal': {'name': 'Portal', 'concept': 'opens portals across the field',
        'throw': ['{player} opens a portal and the ball comes out the other side downfield to {receiver} for {yards} yards'],
        'run':   ['{player} steps into a portal at the line and out of one past the secondary for {yards} yards'],
        'catch': ['{passer} lets it fly and {player} opens a portal at their hands the ball drops through for {yards} yards'],
    ...
    'telekinesis': {'name': 'Telekinesis', 'concept': 'moves the ball with their mind',
        'throw': ['{player} steers the ball downfield to {receiver} with a flick of the mind for {yards} yards'],
        'catch': ['{passer} lets it fly and {player} pulls the ball into their hands without touching it for {yards} yards'],
    ...
    'premonition': {'name': 'Premonition', 'concept': 'already saw this play happen',
        'throw': ['{player} saw this throw a minute ago and {receiver} is already open, good for {yards} yards'],
        'catch': ['{passer} lets it fly and {player} dreamed this catch last night and runs to the spot for {yards} yards'],
        'pick':  ['{player} knew the play before the snap and is already there for the pick'],
        'strip': ['{player} acts on a premonition, meets the runner, and has the ball before it happens']},
    'insider_trading': {'name': 'Insider Trading', 'concept': 'had the call sheet',
        'catch': ['{player} had the call sheet and breaks before {passer} even throws it, good for {yards} yards'],
    ...
    'repo_man': {'name': 'Repo Man', 'concept': 'repossesses the ball',
        'catch': ['{passer} lets it fly and {player} repossesses the ball like a missed payment, good for {yards} yards'],
    ...
    'magnet_hands': {'name': 'Magnet Hands', 'concept': 'magnetized hands rip it free',
        'catch': ['{passer} lets it fly and {player} magnetizes their hands and snaps the ball in for {yards} yards'],
        'pick':  ['{player} magnetizes their hands and snaps the throw in'],
        'strip': ['{player} magnetizes their hands and rips the ball off the runner',
                  '{player} magnetizes their palms and the ball jumps to them off the handoff']},
    'tax_man': {'name': 'Tax Man', 'concept': 'comes to collect their cut',
        'catch': ['{passer} lets it fly and {player} collects their cut, the ball was always owed to them, good for {yards} yards'],
    ...
    'teleport': {'name': 'Teleport', 'concept': 'teleports anywhere on the field',
        'throw': ['{player} teleports out of the pocket and throws to {receiver} from clean grass for {yards} yards'],
        'run':   ['{player} blinks out at the line and rematerializes downfield for {yards} yards'],
        'catch': ['{passer} lets it fly and {player} teleports to the landing spot to catch it in stride for {yards} yards'],
